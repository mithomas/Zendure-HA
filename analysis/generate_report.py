...
print(f"Summary:")
print(f"  Total Avoidable Grid Import (AC charging): {total_import_ac_charge_kwh:.6f} kWh ({sum(import_ac_charge_w):.1f} W-s)")
print(f"  Total Avoidable Grid Export (Secondary blocked): {total_export_blocked_kwh:.6f} kWh ({sum(export_blocked_w):.1f} W-s)")
